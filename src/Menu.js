        ...
        return(
            <div className="Menu">
                <div id="MenuBody" className="MenuBody">
                    <p><button className="arrowbtn" onClick={()=>this.props.changeSpeed(this.props.data.gameSpeed-1)}>&larr;</button>
                    Speed
                    <button className="arrowbtn" onClick={()=>this.props.changeSpeed(this.props.data.gameSpeed+1)}>&rarr;</button></p>
